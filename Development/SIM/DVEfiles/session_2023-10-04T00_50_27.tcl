...
# DVE full session
# Saved on Wed Oct 4 00:50:26 2023
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 149} {height 662} {dock_state left} {dock_on_new_line true} {child_hier_colhier 216} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 661
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 105} {height 662} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 208]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1860
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 208
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1919} {height 207} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMARGS {{+UVM_TESTNAME=ei_tdp_ram_p2_wr_p1_rd_same_addr_test_c +ntb_random_seed=334}}
gui_set_env SIMSETUP::SIMEXE {./simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/mahammadshahid.shaikh/Desktop/TDP_RAM/TDP-RAM-UVC/Development/SIM/simv}] } {
gui_sim_run Ucli -exe simv -args { +UVM_TESTNAME=ei_tdp_ram_p2_wr_p1_rd_same_addr_test_c +ntb_random_seed=334 -ucligui} -dir /home/mahammadshahid.shaikh/Desktop/TDP_RAM/TDP-RAM-UVC/Development/SIM -nosource
}
}
