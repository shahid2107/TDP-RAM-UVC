...
# DVE full session
# Saved on Sat Sep 23 03:06:01 2023
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 105} {height 649} {dock_state left} {dock_on_new_line true} {child_hier_colhier 216} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 648
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 105} {height 649} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1919} {height 220} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMARGS {{+UVM_TESTNAME=ei_tdp_ram_p1_sanity_test_c +UVM_VERBOSITY=FULL}}
gui_set_env SIMSETUP::SIMEXE {./simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/mahammadshahid.shaikh/Desktop/TDP_RAM/TDP-RAM-UVC/Development/SIM/simv}] } {
gui_sim_run Ucli -exe simv -args { +UVM_TESTNAME=ei_tdp_ram_p1_sanity_test_c +UVM_VERBOSITY=FULL -ucligui} -dir /home/mahammadshahid.shaikh/Desktop/TDP_RAM/TDP-RAM-UVC/Development/SIM -nosource
}
}
...
set _session_group_1 pif
gui_sg_create "$_session_group_1"
set pif "$_session_group_1"

gui_sg_addsignal -group "$_session_group_1" { ei_tdp_ram_top.pif.we_a ei_tdp_ram_top.pif.addr_a ei_tdp_ram_top.pif.data_a ei_tdp_ram_top.pif.out_a ei_tdp_ram_top.pif.we_b ei_tdp_ram_top.pif.reset ei_tdp_ram_top.pif.data_b ei_tdp_ram_top.pif.ADDR_WIDTH ei_tdp_ram_top.pif.DATA_WIDTH ei_tdp_ram_top.pif.resetn ei_tdp_ram_top.pif.re_a ei_tdp_ram_top.pif.re_b ei_tdp_ram_top.pif.clk ei_tdp_ram_top.pif.addr_b ei_tdp_ram_top.pif.out_b }
...
catch {gui_list_select -id ${Hier.1} {ei_tdp_ram_top.pif}}
...
gui_list_show_data -id ${Data.1} {ei_tdp_ram_top.pif}
